...
$PackageName = "DesktopIcon_ResMan"
$Version = "1"

# Define the GitHub URLs for the files
$Icon = "https://raw.githubusercontent.com/ChrisFDSTech/Remnant/main/ResMan/ResMan.ico"
...
try {
    Invoke-WebRequest -Uri $Icon -OutFile (Join-Path -Path $directoryPath -ChildPath "ResMan.ico")
}
catch {
